...
Command: npx gltfjsx@6.5.3 dor10.gltf 
*/
...
const Room10 = (props) => {
  const { scene } = useGLTF('/model/glb/dor10.glb')
    ...
    <group {...props} dispose={null}>
      ...
      <group position={[0.469, 0.618, 0.003]} rotation={[0, Math.PI / 2, 0]} scale={0.562}>
        <group position={[0, 0.363, -0.024]}>
          <group position={[0.005, -1.192, 0.108]} scale={[0.47, 0.542, 0.798]}>
            <mesh geometry={nodes.computer_screen002_1.geometry} material={materials.frame} />
            <mesh geometry={nodes.computer_screen002_2.geometry} material={materials['Screen (tv).001']} />
          </group>
      ...
      <group position={[-0.275, 0.161, -3.164]}>
        <group position={[0.777, -0.162, 3.153]} rotation={[0, Math.PI / 2, 0]} scale={0.43}>
          <mesh geometry={nodes.Circle004.geometry} material={materials['monitor_plastic.001']} />
          <mesh geometry={nodes.Circle004_1.geometry} material={materials['monitor_metal white.001']} />
          <mesh geometry={nodes.Circle004_2.geometry} material={materials['monitor_metal 01.001']} />
        </group>
      </group>
      ...
      <group position={[0.432, 0.529, 0.664]} rotation={[Math.PI / 2, 0, -Math.PI / 2]} scale={[0.405, 0.631, 0.405]}>
